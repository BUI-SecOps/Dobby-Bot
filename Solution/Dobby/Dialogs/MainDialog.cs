...
namespace Dobby.Dialogs
{
    ...
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> InitialStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            //    new PromptOptions
            //    {
            //        Prompt = MessageFactory.Text("Please select an action for Dobby to perform"),
        ...
        //        new PromptOptions
        //        {
        //            Prompt = MessageFactory.Text("What kind of TI do you want Dobby to Add?"),
        //            Choices = ChoiceFactory.ToChoices(new List<string> { "IP", "Domain", "Url", "File hash" }),
        //        }, cancellationToken);

        //    //return await stepContext.PromptAsync(nameof(TextPrompt), new PromptOptions { Prompt = MessageFactory.Text("Please enter your name for Dobby.") }, cancellationToken);
        //}
